...
## [0.17.2] - 2025-08-25
### Changed
- No longer access workflow#payload out side of Workflow ([#321](https://github.com/ManageIQ/floe/pull/321))
- Cache choice rule operations  ([#189](https://github.com/ManageIQ/floe/pull/189))

### Fixed
- Fix `Context#==` to compare contents ([#317](https://github.com/ManageIQ/floe/pull/317))
...
[Unreleased]: https://github.com/ManageIQ/floe/compare/v0.17.2...HEAD
[0.17.2]: https://github.com/ManageIQ/floe/compare/v0.17.1...v0.17.2
